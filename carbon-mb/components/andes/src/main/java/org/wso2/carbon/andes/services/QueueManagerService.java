...
import org.wso2.carbon.andes.services.types.QueueRolePermission;
...
public interface QueueManagerService {
     ...
     * @return {@link Queue} the dlc queue
     */
     ...
     * Gets all the queues
     *
     * @return a list of {@link Queue} queues
     * @throws QueueManagerException
     */
     ...
     * @param msgPattern      The exchange type used to transfer messages with the given destinationName. e.g.
     *                        "queue" or "topic"
     ...
     * @throws QueueManagerException
     */
    public void updatePermission(String queueName, QueueRolePermission[]
     ...
     * @throws QueueManagerException
     */
    public void addQueueAndAssignPermission(String queueName, QueueRolePermission[] queueRolePermissions) throws
     ...
     * @throws QueueManagerException
     */
    public Message[] browseQueue(String nameOfQueue,
