...
import org.wso2.carbon.andes.services.beans.QueueManagementBeans;
...
//        try {
            ...
            String tenantBasedQueueName = "admin"; //Utils.getTenantBasedQueueName(queueName);
...
//        }
    ...
    public Queue getQueueByName(String queueName) throws QueueManagerException {
        ...
        if (QueueManagementBeans.getInstance().queueExists(queueName)) {
            ...
            org.wso2.carbon.andes.services.types.Queue queue = new Queue(queueName);
...
//        }
    ...
    public void purgeMessagesOfQueue(String queueName) throws
                                                       QueueManagerException {
        //TODO : C5 user related implementation
        QueueManagementBeans.getInstance().purgeMessagesFromQueue(queueName, "admin");
    }
