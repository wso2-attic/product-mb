...
public class MessagesTestCase {
     ...
     */
    @Test(groups = {"wso2.mb", "rest", "messages"})
    public void getMessagesWithInvalidDestinationTestCase() throws AndesException, IOException, JSONException,
        ...
        Assert.assertEquals(response.getStatusLine().getStatusCode(), 404, "404 not received");
    ...
    public void getMessagesThrowDestinationManagerErrorTestCase() throws AndesException, IOException, JSONException,
        ...
        validateExceptionHandling(response.getEntity());
        Assert.assertEquals(response.getStatusLine().getStatusCode(), 500, "500 not received");
    ...
    public void getMessagesWithNoQueryParamsTestCase() throws AndesException, IOException, JSONException,
        ...
        when(messageManagerService.getMessagesOfDestinationByMessageID(Mockito.anyString(), Mockito.anyString(),
                Mockito.anyString(), Mockito.anyBoolean(), Mockito.anyLong(), Mockito.anyInt())).thenReturn(new
                ArrayList<>());
        ...
        HttpResponse response = httpClient.execute(getRequest);
        Assert.assertEquals(response.getStatusLine().getStatusCode(), 200, "200 not received");

        verify(messageManagerService, atLeastOnce()).getMessagesOfDestinationByMessageID(Mockito.anyString(), Mockito
                .anyString(), Mockito.anyString(), eq(false), eq(0L), eq(100));
    ...
    public void getMessagesWithContentOnlyTestCase() throws AndesException, IOException, JSONException,
        ...
        verify(messageManagerService, atLeastOnce()).getMessagesOfDestinationByMessageID(Mockito.anyString(), Mockito
                .anyString(), Mockito.anyString(), eq(true), Mockito.anyLong(), Mockito.anyInt());
    ...
    public void getMessagesWithMessageIDTestCase() throws AndesException, IOException, JSONException,
        ...
        DefaultHttpClient httpClient = new DefaultHttpClient();
        HttpGet getRequest = new HttpGet(Constants.BASE_URL +
                                         "/amqp-0-91/destination-type/queue/name/mq1/messages?next-message-id" +
                                         "=12345678");
        getRequest.addHeader("Accept", MediaType.APPLICATION_JSON);
        ...
        verify(messageManagerService, atLeastOnce()).getMessagesOfDestinationByMessageID(Mockito.anyString(), Mockito
                .anyString(), Mockito.anyString(), Mockito.anyBoolean(), eq(12345678L), Mockito.anyInt());
    ...
    public void getMessagesWithLimitTestCase() throws AndesException, IOException, JSONException,
        ...
        verify(messageManagerService, atLeastOnce()).getMessagesOfDestinationByMessageID(Mockito.anyString(), Mockito
                .anyString(), Mockito.anyString(), Mockito.anyBoolean(), Mockito.anyLong(), eq(50000));
    ...
    public void getMessagesWithAllQueryParamsTestCase() throws AndesException, IOException, JSONException,
        ...
        HttpGet getRequest = new HttpGet(Constants.BASE_URL +
                                         "/amqp-0-91/destination-type/queue/name/mq1/messages?next-message-id" +
                                         "=12345678&limit=7000&content=true");
        getRequest.addHeader("Accept", MediaType.APPLICATION_JSON);
        ...
        verify(messageManagerService, atLeastOnce()).getMessagesOfDestinationByMessageID(Mockito.anyString(), Mockito
                .anyString(), Mockito.anyString(), eq(true), eq(12345678L), eq(7000));
    ...
    public void getMessageWithDefaultQueryParamsTestCase() throws MessageManagerException, AndesException,
        ...
        when(messageManagerService.getMessage(Mockito.anyString(), Mockito.anyString(), Mockito.anyString(), Mockito
                .anyLong(), Mockito.anyBoolean())).thenReturn(messageMock);
        ...
        verify(messageManagerService, atLeastOnce()).getMessage(Mockito.anyString(), Mockito.anyString(), Mockito
                .anyString(), eq(789789L), eq(false));
    ...
    public void getMessageWithoutContentTestCase() throws MessageManagerException, AndesException, IOException,
        ...
        MessageManagerService messageManagerService = mock(MessageManagerService.class);
        when(messageManagerService.getMessage(Mockito.anyString(), Mockito.anyString(), Mockito.anyString(), Mockito
                .anyLong(), Mockito.anyBoolean())).thenReturn(new Message());
    ...
    public void getNonExistingMessageTestCase() throws MessageManagerException, AndesException, IOException,
        ...
        MessageManagerService messageManagerService = mock(MessageManagerService.class);
        when(messageManagerService.getMessage(Mockito.anyString(), Mockito.anyString(), Mockito.anyString(), Mockito
                .anyLong(), Mockito.anyBoolean())).thenReturn(null);
    ...
    public void getMessageThrowMessageManagerErrorTestCase() throws MessageManagerException, AndesException,
        ...
        MessageManagerService messageManagerService = mock(MessageManagerService.class);
        when(messageManagerService.getMessage(Mockito.anyString(), Mockito.anyString(), Mockito.anyString(), Mockito
                .anyLong(), Mockito.anyBoolean())).thenThrow(new MessageManagerException("Message Manager Error"));
        ...
        verify(messageManagerService, atLeastOnce()).getMessage(Mockito.anyString(), Mockito.anyString(), Mockito
                .anyString(), Mockito.anyLong(), Mockito.anyBoolean());
    ...
    public void purgeMessagesTestCase() throws DestinationManagerException, MessageManagerException, IOException {
        ...
        HttpResponse response = httpClient.execute(deleteRequest);
        Assert.assertEquals(response.getStatusLine().getStatusCode(), 204, "204 not received");

        verify(messageManagerService, atLeastOnce()).deleteMessages(Mockito.anyString(), Mockito.anyString(), Mockito
                .anyString());
