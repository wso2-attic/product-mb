...
public class Utils {
    ...
    //                if (subscription.getSubscribedQueueOrTopicName().startsWith(domainName + AndesConstants
    // .TENANT_SEPARATOR)) {
    ...
    /**
     * Parsing a string to a {@link Subscription}
     *
    ...
    public static String getTCPConnectionURL(String userName, String accessKey)
        ...
        Integer carbonPort = AndesConfigurationManager.readValue(AndesConfiguration
        ...
        String sslPort = String.valueOf(AndesConfigurationManager.readValue(AndesConfiguration
                .TRANSPORTS_AMQP_SSL_CONNECTION_PORT));
    ...
    public static boolean isSSLOnly() throws FileNotFoundException, XMLStreamException {
        ...
        return (Boolean) AndesConfigurationManager.readValue(AndesConfiguration
                .TRANSPORTS_AMQP_SSL_CONNECTION_ENABLED) &&
               !(Boolean) AndesConfigurationManager.readValue(AndesConfiguration
                       .TRANSPORTS_AMQP_DEFAULT_CONNECTION_ENABLED);
    }
