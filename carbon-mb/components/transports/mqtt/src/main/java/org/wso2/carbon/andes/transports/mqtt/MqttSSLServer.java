...
/**
 * Starts the mqtt server using a secure connection
 */
public class MqttSSLServer extends AbstractServer {

    /**
     * Holds the information relevant to create a ssl connection with the server
     */
    private SSLContext sslContext;

    public MqttSSLServer(SSLContext sslContext) {
        this.sslContext = sslContext;
    }


    /**
     * Creates a netty ssl handler, deriving from the provided ssl context
     *
     * @return ssl handler which contains ssl validation phase
     */
    private SslHandler getSSLConnectionEngine() {
