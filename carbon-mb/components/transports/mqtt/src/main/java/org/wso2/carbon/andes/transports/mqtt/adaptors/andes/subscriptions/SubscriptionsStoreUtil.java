...
/**
 * MQTT subscription store utility class to match topics
 */
public class SubscriptionsStoreUtil {

    private static final Logger LOG = LoggerFactory.getLogger(SubscriptionsStoreUtil.class);

    public static boolean matchTopics(String msgTopic, String subscriptionTopic) {

        try {
            List<Token> msgTokens = SubscriptionsStoreUtil.splitTopic(msgTopic);
