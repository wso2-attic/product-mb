...
public class Utils {
    ...
    static boolean checkHeaderAvailability(ByteBuf in) {
        ...
        int remainingLength = org.dna.mqtt.moquette.parser.netty.Utils.decodeRemainingLenght(in);
    ...
    public static ByteBuf encodeString(String str) {
        ...
        try {
            ...
            LoggerFactory.getLogger(org.dna.mqtt.moquette.parser.netty.Utils.class).error(null, ex);
            return null;
        }
