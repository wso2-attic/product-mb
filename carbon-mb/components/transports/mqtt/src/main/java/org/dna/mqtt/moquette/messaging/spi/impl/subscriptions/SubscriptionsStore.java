...
public class SubscriptionsStore {
    ...
    private class DumpTreeVisitor implements IVisitor<String> {
        ...
        public void visit(org.dna.mqtt.moquette.messaging.spi.impl.subscriptions.TreeNode node) {
            ...
            for (org.dna.mqtt.moquette.messaging.spi.impl.subscriptions.Subscription sub : node.m_subscriptions) {
    ...
    private class SubscriptionTreeCollector implements IVisitor<List<org.dna.mqtt.moquette.messaging.spi.impl.subscriptions.Subscription>> {

        private List<org.dna.mqtt.moquette.messaging.spi.impl.subscriptions.Subscription> m_allSubscriptions = new ArrayList<org.dna.mqtt.moquette.messaging.spi.impl.subscriptions.Subscription>();
    ...
    private org.dna.mqtt.moquette.messaging.spi.impl.subscriptions.TreeNode subscriptions = new org.dna.mqtt.moquette.messaging.spi.impl.subscriptions.TreeNode(null);
    ...
    public void init(IPersistentSubscriptionStore storageService) {
        ...
        for (org.dna.mqtt.moquette.messaging.spi.impl.subscriptions.Subscription subscription : m_storageService.retrieveAllSubscriptions()) {
    ...
    protected void addDirect(org.dna.mqtt.moquette.messaging.spi.impl.subscriptions.Subscription newSubscription) {
        org.dna.mqtt.moquette.messaging.spi.impl.subscriptions.TreeNode current = findMatchingNode(newSubscription.topic);
    ...
    private org.dna.mqtt.moquette.messaging.spi.impl.subscriptions.TreeNode findMatchingNode(String topic) {
        List<org.dna.mqtt.moquette.messaging.spi.impl.subscriptions.Token> tokens = new ArrayList<org.dna.mqtt.moquette.messaging.spi.impl.subscriptions.Token>();
        try {
...
//            return;
     ...
     */
    public org.dna.mqtt.moquette.messaging.spi.impl.subscriptions.Subscription getSubscriptions(String topic,String clientID){
    ...
    public void clearAllSubscriptions() {
        ...
        List<org.dna.mqtt.moquette.messaging.spi.impl.subscriptions.Subscription> allSubscriptions = subsCollector.getResult();
    ...
    public List<org.dna.mqtt.moquette.messaging.spi.impl.subscriptions.Subscription> matches(String topic) {
        ...
        Queue<org.dna.mqtt.moquette.messaging.spi.impl.subscriptions.Token> tokenQueue = new LinkedBlockingDeque<org.dna.mqtt.moquette.messaging.spi.impl.subscriptions.Token>(tokens);
        List<org.dna.mqtt.moquette.messaging.spi.impl.subscriptions.Subscription> matchingSubs = new ArrayList<org.dna.mqtt.moquette.messaging.spi.impl.subscriptions.Subscription>();
    ...
    private void bfsVisit(org.dna.mqtt.moquette.messaging.spi.impl.subscriptions.TreeNode node, IVisitor visitor) {
        ...
        visitor.visit(node);
        for (org.dna.mqtt.moquette.messaging.spi.impl.subscriptions.TreeNode child : node.m_children) {
    ...
    public static boolean matchTopics(String msgTopic, String subscriptionTopic) {
        try {
            ...
            for (; i< subscriptionTokens.size(); i++) {
                ...
                if (subToken != org.dna.mqtt.moquette.messaging.spi.impl.subscriptions.Token.MULTI && subToken != org.dna.mqtt.moquette.messaging.spi.impl.subscriptions.Token.SINGLE) {
                    if (i >= msgTokens.size()) {
                        return false;
                    }
    ...
    protected static List<org.dna.mqtt.moquette.messaging.spi.impl.subscriptions.Token> splitTopic(String topic) throws ParseException {
