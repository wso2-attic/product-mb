...
import org.wso2.carbon.andes.transports.mqtt.broker.SubscriberAcknowledgementProcessor;
...
public class PublisherReceived {
     ...
     * @return Subscribe
     */
    public static boolean notifyStore(MessagingAdaptor messageStore, PubRecMessage message, MqttChannel channel)
            throws
            BrokerException {
