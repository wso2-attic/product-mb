 ...
 * @author andrea
 */
public class ConnectDecoder extends org.dna.mqtt.moquette.parser.netty.DemuxDecoder {
    ...
    void decode(AttributeMap ctx, ByteBuf in, List<Object> out) throws UnsupportedEncodingException {
        ...
        if (message.getProcotolVersion() == VERSION_3_1_1) {
            ...
            Attribute<Boolean> connectAttr = ctx.attr(org.dna.mqtt.moquette.parser.netty.ConnectDecoder.CONNECT_STATUS);
