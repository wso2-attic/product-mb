...
public enum QOSLevel {
     ...
     */
    public static org.dna.mqtt.wso2.QOSLevel getQoSFromValue(int qos) {
        switch (qos) {
            case 0:
                return org.dna.mqtt.wso2.QOSLevel.AT_MOST_ONCE;
            case 1:
                return org.dna.mqtt.wso2.QOSLevel.AT_LEAST_ONCE;
            case 2:
                return org.dna.mqtt.wso2.QOSLevel.EXACTLY_ONCE;
            default:
                return org.dna.mqtt.wso2.QOSLevel.AT_MOST_ONCE;
        }
    }
