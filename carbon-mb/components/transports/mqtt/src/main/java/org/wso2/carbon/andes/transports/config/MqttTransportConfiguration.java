...
/**
 * Would read the attributes from the yaml
 */
...
public class MqttTransportConfiguration {
    ...
    /**
     * Holds the generic mqtt properties
     */
    @XmlElement(name = "mqtt")
    private MqttTransportProperties mqttTransportProperties;

    /**
     * Holds the secured mqtt transport properties
     */
    ...
    public MqttSecuredTransportProperties getMqttSecuredTransportProperties() {
        return mqttSecuredTransportProperties;
    }
