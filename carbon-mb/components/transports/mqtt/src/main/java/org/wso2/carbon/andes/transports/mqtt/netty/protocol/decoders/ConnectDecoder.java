...
public class ConnectDecoder extends DemuxDecoder {
    ...
    void decode(AttributeMap ctx, ByteBuf in, List<Object> out) throws UnsupportedEncodingException {
        ...
        if (message.getProcotolVersion() == Utils.VERSION_3_1_1) {
        ...
        if ((remainingLength == 12 && message.getProcotolVersion() == Utils.VERSION_3_1) ||
            (remainingLength == 10 && message.getProcotolVersion() == Utils.VERSION_3_1_1)) {
            out.add(message);
            return;
        }
