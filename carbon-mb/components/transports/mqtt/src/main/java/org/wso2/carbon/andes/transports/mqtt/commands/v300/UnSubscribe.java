...
import org.wso2.carbon.andes.transports.mqtt.protocol.messages.UnsubAckMessage;
...
public class UnSubscribe {
     ...
     * @return Subscribe
     */
    public static boolean notifyStore(IConnector messageStore, UnsubscribeMessage message, MqttChannel channel) throws
            BrokerException {
