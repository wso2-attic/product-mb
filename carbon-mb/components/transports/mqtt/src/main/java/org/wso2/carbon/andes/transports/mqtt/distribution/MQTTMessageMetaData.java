 ...
 * under the License.
 */
package org.wso2.carbon.andes.transports.mqtt.distribution;
...
public class MqttMessageMetaData implements StorableMessageMetaData {
    public static final MessageMetaDataType.Factory<org.wso2.andes.mqtt.MQTTMessageMetaData> FACTORY
            = new MetaDataFactory();
    ...
    private static class MetaDataFactory implements
            MessageMetaDataType.Factory<org.wso2.andes.mqtt.MQTTMessageMetaData> {
        /**
         ...
         */
        @Override
        public org.wso2.andes.mqtt.MQTTMessageMetaData createMetaData(ByteBuffer buf) {
            ...
            return new org.wso2.andes.mqtt.MQTTMessageMetaData(messageID,
                    messageArrivalTime,
                    isTopic,
