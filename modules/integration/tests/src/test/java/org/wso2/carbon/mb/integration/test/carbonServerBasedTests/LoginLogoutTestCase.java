...
package org.wso2.carbon.mb.integration.test.carbonServerBasedTests;
...
public class LoginLogoutTestCase extends MbMasterTestCase{
    ...
    public void login() throws Exception {
        util = new LoginLogoutUtil(getEnvironment().getBackEndUrl());
        try {
            Thread.sleep(10000);
        ...
        ClientConnectionUtil.waitForPort(9763,getEnvironment().getProductVariables().getHostName());
        util.login("admin", "admin", getEnvironment().getBackEndUrl());
    }
