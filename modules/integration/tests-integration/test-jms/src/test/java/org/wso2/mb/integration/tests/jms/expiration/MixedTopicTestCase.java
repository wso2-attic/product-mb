...
/***
 * This class includes unit tests to verify that messages with JMS expiration are properly removed when delivering to non-durable topics.
 */
public class MixedTopicTestCase extends MBIntegrationBaseTest {
    ...
    public void performSingleTopicSendReceiveTestCase() {
        ...
        AndesClient receivingClient = new AndesClient("receive", "127.0.0.1:5672", "topic:singleTopic",
                ...
                "1", "listener=true,ackMode=1,delayBetweenMsg=0,stopAfter="+expectedMessageCountFromSubscriberSession, "");
