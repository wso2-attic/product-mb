...
public class DiscardAllowedMsgDeliveryStrategyTestCase extends MBIntegrationBaseTest {
	...
	public void performDiscardAllowedTopicMessageDelivery() throws AndesClientConfigurationException, JMSException, NamingException, IOException,
		...
		Assert.assertEquals(expectedMessageCountPerSubscriber, consumerClient1.getReceivedMessageCount());
		Assert.assertEquals(expectedMessageCountPerSubscriber, consumerClient2.getReceivedMessageCount());
		Assert.assertEquals(expectedMessageCountPerSubscriber, consumerClient3.getReceivedMessageCount());
		Assert.assertEquals(expectedMessageCountPerSubscriber, consumerClient4.getReceivedMessageCount());
