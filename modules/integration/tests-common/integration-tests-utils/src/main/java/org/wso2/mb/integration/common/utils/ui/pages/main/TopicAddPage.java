...
public class TopicAddPage extends MBPage {
    ...
    /**
     * Checks whether the current page the WebDriver is in is the correct topic add page. if not
     * throws a runtime exception (IllegalStateException)
     *
     * @param driver WebDriver
     */
    public TopicAddPage(WebDriver driver) {
        super(driver);
        if(!driver.findElement(By.xpath(UIElementMapper.getInstance().
                getElement("mb.add.topic.page.header.xpath"))).getText().contains("Add Topic")){
            throw new IllegalStateException("This is not the Add Topic page");
        }
    }

    /**
     * Adds a topic with all without changing privileges for the topic
     * @param topicName topic name
     * @return true if successful and false otherwise
     * @throws java.io.IOException
     */
    public boolean addTopic(final String topicName) throws IOException {
        return addTopic(topicName, true);
    }
     ...
     * @throws IOException
     */
    public boolean addTopic(final String topicName, boolean withoutPrivileges) throws IOException{
        boolean isSuccessful = false;

        WebElement qNameField = driver.findElement(By.id(UIElementMapper.getInstance()
                .getElement("mb.add.topic.page.topic.name.field.id")));
        ...
        driver.findElement(By.xpath(UIElementMapper.getInstance()
                .getElement("mb.add.topic.page.add.button.xpath"))).click();
        ...
        driver.findElement(By.xpath(UIElementMapper.getInstance().getElement("mb.add.topic.page.ontopicadd.okbutton.xpath"))).click();
