...
public class QueuesBrowsePage {
    ...
    private WebElement getTableRowByQueueName(final String qName){
        WebElement workArea = driver.findElement(By.id(UIElementMapper.getInstance().getElement("mb.queue.list.page.workarea.id")));
        List<WebElement> rowElementList = workArea.findElements(By.tagName("tr"));
