...
INPUT_FILES=PATH-TO-INPUT-DATAFILES DIRECTORY/*                     #Path for the directory where text files are stored/*
...
interim_file=PATH-TO-PROJECT-FOLDER/graph_generator/searched.txt    #New file path for the intermediate operations
interim_file1=PATH-TO-PROJECT-FOLDER/graph_generator/searched1.txts
#--------------------------------------------------------
