...
publishers_resultfile_name=$durable_topics_result_dir/$messageSize\_test_publisher_nodes_$nodes\_durable_topics_$topics\_$publishers_per_topic\_result.txt;
